...
export const codGray = '#ffffff';
export const codGray2 = '#181818';
export const codGrayOpacity = 'rgba(ee, ee, ee, 0)';
export const white20 = 'rgba(255, 255, 255, 0.2)';
export const boulder = '#19194A';
export const mineShaft = '#434378';
export const scorpion = '#f1f1f1';
export const silver = '#f1f1f1';
...
export const nanogiantsBlue = '#434378';
export const nanogiantsDarkBlue = '#19194A';
export const nanogiantsDarkRed = '#D90855';
